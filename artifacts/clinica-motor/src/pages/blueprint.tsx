...
const CLINICAS: Empresa[] = [
  ...
  },
  {
    ...
    razaoSocial: "BARA CLINICA MEDICA LTDA",
    cnpj: "13.517.063/0001-61",
    dono: "Dr. Mohamad Barakat",
    inscricaoEstadual: "Isenta",
    inscricaoMunicipal: "(emitir FDC na Prefeitura SP)",
    endereco: "Avenida Brasil, 239",
    bairro: "Jardim América",
    cidade: "São Paulo",
    uf: "SP",
    cep: "01431-000",
    certificadoDigital: "(arquivo .pfx a anexar — parceiro)",
    certificadoSenha: "(a definir — parceiro)",
    fonteDados: "REAL",

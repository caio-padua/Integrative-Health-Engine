...
import contratosFarmaciaRouter from "./contratosFarmacia";
...
import auditoresRouter from "./auditores";
import painelPawardsRouter from "./painelPawards";
...
import prescricoesRouter from "./prescricoes";
import relatorioOperacionalDiaRouter from "./relatorioOperacionalDia";
...
router.use(contratosFarmaciaRouter);
...
router.use(auditoresRouter);
router.use("/painel-pawards", painelPawardsRouter);

...
router.post("/doencas", (req, res) => handlePost(doencasTable, req, res));
router.put("/doencas/:id", (req, res) => handlePut(doencasTable, doencasTable.id, req, res));
router.delete("/doencas/:id", (req, res) => handleDelete(doencasTable, doencasTable.id, req, res));
router.post("/regras-injetaveis", (req, res) => handlePost(regrasInjetaveisTable, req, res));
router.put("/regras-injetaveis/:id", (req, res) => handlePut(regrasInjetaveisTable, regrasInjetaveisTable.id, req, res));
router.delete("/regras-injetaveis/:id", (req, res) => handleDelete(regrasInjetaveisTable, regrasInjetaveisTable.id, req, res));
router.post("/regras-endovenosos", (req, res) => handlePost(regrasEndovenososTable, req, res));
router.put("/regras-endovenosos/:id", (req, res) => handlePut(regrasEndovenososTable, regrasEndovenososTable.id, req, res));
router.delete("/regras-endovenosos/:id", (req, res) => handleDelete(regrasEndovenososTable, regrasEndovenososTable.id, req, res));
router.post("/regras-implantes", (req, res) => handlePost(regrasImplantesTable, req, res));
router.put("/regras-implantes/:id", (req, res) => handlePut(regrasImplantesTable, regrasImplantesTable.id, req, res));
router.delete("/regras-implantes/:id", (req, res) => handleDelete(regrasImplantesTable, regrasImplantesTable.id, req, res));
router.post("/mapa-anamnese", (req, res) => handlePost(mapaAnamneseMotorTable, req, res));
router.put("/mapa-anamnese/:id", (req, res) => handlePut(mapaAnamneseMotorTable, mapaAnamneseMotorTable.id, req, res));
router.delete("/mapa-anamnese/:id", (req, res) => handleDelete(mapaAnamneseMotorTable, mapaAnamneseMotorTable.id, req, res));
router.post("/motor-decisao", (req, res) => handlePost(motorDecisaoTable, req, res));
router.put("/motor-decisao/:id", (req, res) => handlePut(motorDecisaoTable, motorDecisaoTable.id, req, res));
router.delete("/motor-decisao/:id", (req, res) => handleDelete(motorDecisaoTable, motorDecisaoTable.id, req, res));
router.post("/recorrencia", (req, res) => handlePost(recorrenciaTable, req, res));
router.put("/recorrencia/:id", (req, res) => handlePut(recorrenciaTable, recorrenciaTable.id, req, res));
router.delete("/recorrencia/:id", (req, res) => handleDelete(recorrenciaTable, recorrenciaTable.id, req, res));
router.post("/matriz-rastreio", (req, res) => handlePost(matrizRastreioTable, req, res));
router.put("/matriz-rastreio/:id", (req, res) => handlePut(matrizRastreioTable, matrizRastreioTable.id, req, res));
router.delete("/matriz-rastreio/:id", (req, res) => handleDelete(matrizRastreioTable, matrizRastreioTable.id, req, res));
router.post("/regras-triagem", (req, res) => handlePost(regrasTriagemTable, req, res));
router.put("/regras-triagem/:id", (req, res) => handlePut(regrasTriagemTable, regrasTriagemTable.id, req, res));
router.delete("/regras-triagem/:id", (req, res) => handleDelete(regrasTriagemTable, regrasTriagemTable.id, req, res));

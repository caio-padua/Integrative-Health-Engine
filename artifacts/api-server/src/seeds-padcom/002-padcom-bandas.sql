...
INSERT INTO padcom_bandas (id, nome, cor, score_minimo, score_maximo, descricao, acoes_motor, prioridade, ativo)
VALUES
  (
    gen_random_uuid(),
    'Verde — Manutenção',
...
-- Verificação
-- SELECT nome, cor, score_minimo, score_maximo, ordem FROM padcom_bandas ORDER BY ordem;

# Contexto Extra do Projeto PADCON (complemento)

## replit.md (memória persistente do projeto)
```markdown
...
## Schema Drizzle legado relevante (apenas tabelas que se relacionam com PADCON)
```sql
...
## Seed das 70 liberações (regra de negócio crítica)
```
ERROR:  column l.template_codigo does not exist
LINE 1: SELECT u.nome, l.template_codigo, l.tipo_liberacao FROM agen...
                       ^
```

## Eventos cobráveis com preço atual
```
ERROR:  column "preco" does not exist
LINE 1: SELECT codigo, nome, preco, unidade_cobranca FROM eventos_co...
                             ^
```

## Estrutura Drive provisionada (10 institutos)
```
         nome          |                                 url_raiz                                 
-----------------------+--------------------------------------------------------------------------

...
15. **Pedidos de Exame** — Criar pedidos de exame com busca de paciente e selecao de exames da base V4 (220 exames), validacao medica com opcao de incluir justificativa para convenio/laboratorio (3 niveis: objetiva, narrativa, robusta), previa de justificativas antes de validar, geracao de 2 PDFs: (1) Solicitacao de Exames com cabecalho clinica/paciente, receituario especial, lista de exames com preparo, HD/CID, assinatura digital; (2) Justificativa para Solicitacao com texto do nivel escolhido por exame. Tabela pedidos_exame com JSONB de exames, status RASCUNHO→VALIDADO
